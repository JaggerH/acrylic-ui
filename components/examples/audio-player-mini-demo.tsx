...
// The `mini` variant, shown the way it sits in a sidebar footer — expanded, and in the collapsed
// icon-rail mode. Local state drives play/seek; a 1s tick advances the elapsed time while playing.
// `onOpen` (cover/title click) would navigate to the full player in a real app.
